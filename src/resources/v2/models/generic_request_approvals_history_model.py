...
class GenericRequestApprovalsHistory(db.Model):
    """ GenericRequestApprovalsHistory model """

    __tablename__ = "lc_generic_request_approvals_history"
    ...
    @staticmethod
    def get_all():
        return GenericRequestApprovalsHistory.query.filter_by(deleted_at=None)
