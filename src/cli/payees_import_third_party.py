...
class PayeesImportThirdParty(Command):
    def __init__(self, db=None, filename=None, sheetname="IMPORT 3RD PARTIES"):
        self.db = db
    ...
    def import_third_party(self):
        ...
        for i in file_data.index:
            ...
            # Beneficiary Name
            if (
                "Beneficiary Name (Nickname)" in file_data
                and file_data["Beneficiary Name (Nickname)"][i]
            ):
                beneficiary_name = str(file_data["Beneficiary Name (Nickname)"][i])

            # Beneficiary Id
            if (
                "Beneficiary Id" in file_data
                and file_data["Beneficiary Id"][i]
            ):
                beneficiary_id = str(file_data["Beneficiary Id"][i])
            ...
            if (
                ...
                beneficiary_account_number = str(file_data["Beneficiary Account Number"][i])
            ...
            # Beneficiary Bank Id Type
            if (
                "Beneficiary Bank Id Type" in file_data
                and file_data["Beneficiary Bank Id Type"][i]
            ):
                beneficiary_bank_id_type = str(file_data["Beneficiary Bank Id Type"][i])
            ...
            print(beneficiary_name, "--import third party - beneficiary--", i)
            print("====end====")
