...
class PayeesImportWire(Command):
    def __init__(self, db=None, filename=None, sheetname="IMPORT WIRE"):
        self.db = db
            ...
            file_data = file_data.replace(
                {
                    ...
                    "NA": None,  # All values with NA is actually NULL
                    "n/a": None,  # All values with n/a is actually NULL
                }
            )
    ...
    def import_wire(self):
        ...
        for i in file_data.index:
            ...
            # bank account name
            if (
                "Wire Beneficiary Name" in file_data
                and file_data["Wire Beneficiary Name"][i]
            ):
                bank_account_name = str(file_data["Wire Beneficiary Name"][i])
            ...
            print(beneficiary_name, "--import wire - beneficiary--", i)
            print("====end====")
