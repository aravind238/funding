...
class PayeesImportAch(Command):
    def __init__(self, db=None, filename=None, sheetname="IMPORT ACH"):
        self.db = db
    ...
    def import_ach(self):
        ...
        for i in file_data.index:
            ...
            # Beneficiary Name/ACH Beneficiary Name
            if (
                "ACH Beneficiary Name" in file_data
                and file_data["ACH Beneficiary Name"][i]
            ):
                beneficiary_name = str(file_data["ACH Beneficiary Name"][i])
            elif (
                "Beneficiary Name (Nickname)" in file_data
                and file_data["Beneficiary Name (Nickname)"][i]
            ):
                beneficiary_name = str(
                    file_data["Beneficiary Name (Nickname)"][i]
                )
            ...
            if client:
                ...
                print(client.id, "--has payee--", payee)
            ...
            print(beneficiary_name, "--import ach - beneficiary--", i)
            print("====end====")
